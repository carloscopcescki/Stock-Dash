...
if get_market == "Fundos Imobiliários":
    try:
        ...
        if stock:
            ...
            with col_fii_info2:
                st.markdown(f"**Imóveis:** https://www.fundamentus.com.br/fii_fatos_relevantes.php?papel={stock}")
                st.markdown(f"**Relatórios:** https://www.fundamentus.com.br/fii_relatorios.php?papel={stock}")
                st.markdown(f"**Comunicados:** https://www.fundamentus.com.br/fii_imoveis_detalhes.php?papel={stock}")
